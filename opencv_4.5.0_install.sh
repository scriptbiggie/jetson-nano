...
#CUDA, cuDNN, FFmpeg, Gstreamer compiled OpenCV 4.5.0 Installation for Jetson Nano
#Tried on JetPack 4.4.1

##
## Run this script after you completed the initial step.
## If not, please refer to README.md
##
